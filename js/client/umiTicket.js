...
umiTicket.prototype.renderTicket = function () {
	...
	editLink.appendChild( document.createTextNode(getLabel('js-client-umiTicket-edit')));
	...
	delLink.appendChild( document.createTextNode(getLabel('js-client-umiTicket-remove_mark')));
