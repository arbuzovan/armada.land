...
$i18n = Array(
	...
	"option-busy_quota_files_and_images"	=> "Percent of busy disk size (summary for /files/ and /images/, Mb)",
	...
	"option-quota_uploads"	=> "Restriction of disk space for directory /sys-temp/uploads/, Мб",
	...
	"option-cache-size-limit" => "Cache size limit",
	"cache-engine-on" => "Working",
	"cache-engine-off" => "Out of service",
	"cache-size-limit-off" => "Not specified",
